            ...
            <div class="px-4 py-5 sm:p-6">
                <form action="{{ route('admin.users.update', $user['id']) }}" method="POST">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <label class="block text-sm font-medium text-gray-700">Email Address (Cannot be changed
                                here)</label>
                            <div
                                class="mt-1 block w-full py-2 px-3 bg-gray-50 border border-gray-300 rounded-md text-gray-500 sm:text-sm">
                                {{ $user['email'] ?? 'N/A' }}
                            </div>
                        </div>
